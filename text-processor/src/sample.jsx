...
const App = () => {
      ...
      setTimeout(async () => {
        try {
          ...
          const detectionMessage = {
            ...
            isUser: false,
            detectedLanguage: detectedLanguageCode, // Store detected language for translation
            originalText: text, // Store original text for translation
          };
  ...
  // Updated handleTranslate to insert the "Translating..." message after the message being translated
        ...
        <div className="p-4 space-y-3">
          ...
          {messages.map((message) => (
            ...
            >
              ...
              {/* Translation Dropdown and Button - only shown for non-user messages with detected language */}
              {!message.isUser &&
